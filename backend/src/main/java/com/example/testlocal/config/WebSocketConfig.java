...
public class WebSocketConfig implements WebSocketMessageBrokerConfigurer{
    ...
    @Override
    public void registerStompEndpoints(StompEndpointRegistry registry) {    // 해당 링크로 동작하는 SockJS를 만들어 등록
    ...
    @Override
    public void configureMessageBroker(MessageBrokerRegistry registry){ // publish, subscribe 할 때 사용할 url prefix 설정
